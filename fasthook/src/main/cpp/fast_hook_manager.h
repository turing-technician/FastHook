...
//DF F8 3C C0 ; ldr ip, [pc, #60] 1f
//60 45       ; cmp r0, ip
//00 bf       ; nop
//40 F0 16 80 ; bne.w #44
//DF F8 40 C0 : ldr ip, [pc, #64] 5f
//CC F8 00 10 : str r1, [ip]
//CC F8 08 20 : str r2, [ip, #8]
//CC F8 10 30 : str r3, [ip, #16]
//63 46       : mov r3, ip
//00 bf       ; nop
//84 46       ; mov ip, r0
//00 bf       ; nop
...
//00 00 00 00 ; 1f hook method
//00 00 00 00 : 2f parm cache
...
//91 02 00 58 ; ldr x17, #80 1f
//1F 00 11 EB ; cmp x0, x17
//01 02 00 54 ; bne #64
//31 03 00 58 : ldr x17, #100 5f
//21 02 00 F9 : str x1, [x17]
//22 06 00 F9 : str x2, [x17, #8]
//23 0A 00 F9 : str x3, [x17, #16]
//24 0E 00 F9 : str x4, [x17, #24]
//25 12 00 F9 : str x5, [x17, #32]
//26 16 00 F9 : str x6, [x17, #40]
//27 1A 00 F9 : str x7, [x17, #48]
//E3 03 11 AA : mov x3, x17
...
//00 00 00 00 00 00 00 00 ; 5f:param cache
unsigned char quick_hook_trampoline_[] = {
		0x91, 0x02, 0x00, 0x58,
        0x1f, 0x00, 0x11, 0xeb,
        0x01, 0x02, 0x00, 0x54,
...
//00 00 00 00 00 00 00 00 ; 1f:param cache
unsigned char hook_trampoline_[] = {
        0x31, 0x02, 0x00, 0x58,
        0x21, 0x02, 0x00, 0xf9,
        0x22, 0x06, 0x00, 0xf9,
